...
from src.step6_cv.common import load_json, load_step6_cv_config, resolve_path, save_json
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Step 6 CV inference-only entry")
