...
Usage:
    uv run src/LLMs/classify_with_llms.py --model gpt
    uv run src/LLMs/classify_with_llms.py --model claude
    uv run src/LLMs/classify_with_llms.py --model gemini
    uv run src/LLMs/classify_with_llms.py --model gemma
    uv run src/LLMs/classify_with_llms.py --model all
    uv run src/LLMs/classify_with_llms.py --model gpt --dry-run 3
"""
...
MODELS = {
    ...
    "gemma": {
        "name": "Gemma-3-4B",
        "model_str": "src/fine-tuning/gemma_3_lora",  # LoRA adapter path
...
def main():
    ...
    parser.add_argument(
        ...
        default="src/fine-tuning/gemma_3_lora",
